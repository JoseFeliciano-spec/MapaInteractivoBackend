...
@Controller('v1/user/register-driver')
export class CreateUserDriverController {
  constructor(private readonly createUserUseCase: CreateUserUseCase) {}

  @Post()
  @ApiOperation({
    summary: 'Registrar un nuevo usuario',
    description: 'Crea un nuevo usuario en el sistema validando los datos de entrada',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiBadRequestResponse({
    ...
    schema: {
      example: {
        ...
        message: 'Hubo un error al crear el usuario. Por favor, inténtalo nuevamente.',
        statusCode: 400,
      },
    },
  })
